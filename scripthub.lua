...
if identifyexecutor() then
    ...
    if executor == "Solara" or executor == "Nezur" or executor == "JJSploit" then
        lplr:Kick("Unsupported executor: " .. executor .. " Please use xeno. copied invite to your clipboard")
        setclipboard("https://discord.com/invite/2HUGfKttxH")
    end
end
